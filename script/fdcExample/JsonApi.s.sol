...
contract PrepareAttestationRequest is Script {
    ...
    string public publicAbiSignature =
        "{\\'components\\': ["
...
// Run with command
// solhint-disable-next-line max-line-length
//      forge script script/fdcExample/JsonApi.s.sol:SubmitAttestationRequest --rpc-url $COSTON2_RPC_URL --broadcast --ffi
...
// Run with command
// solhint-disable-next-line max-line-length
//      forge script script/fdcExample/JsonApi.s.sol:RetrieveDataAndProof --private-key $PRIVATE_KEY --rpc-url $COSTON2_RPC_URL --broadcast --ffi
...
// solhint-disable-next-line max-line-length
// forge script script/fdcExample/JsonApi.s.sol:DeployContract --private-key $PRIVATE_KEY --rpc-url $COSTON2_RPC_URL --broadcast --verify --verifier blockscout --verifier-url $COSTON2_EXPLORER_API --ffi
...
// solhint-disable-next-line max-line-length
// forge script script/fdcExample/JsonApi.s.sol:InteractWithContract --private-key $PRIVATE_KEY --rpc-url $COSTON2_RPC_URL --broadcast --ffi
