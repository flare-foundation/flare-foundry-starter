...
// forge script script/fassets/AutoRedeemFromHyperEVM.s.sol:AutoRedeemFromHyperEVM --private-key $PRIVATE_KEY --rpc-url $HYPERLIQUID_TESTNET_RPC_URL --broadcast

/**
 * @title AutoRedeemFromHyperEVM
 * @notice Script to send FXRP from Hyperliquid EVM Testnet to Coston2 with automatic redemption
 * @dev Uses LayerZero compose to trigger automatic redemption on Coston2
 */
contract AutoRedeemFromHyperEVM is Script {
