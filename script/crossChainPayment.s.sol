...
contract PrepareAttestationRequest is Script {
    ...
    string public transactionHash = "0x4e636c6590b22d8dcdade7ee3b5ae5572f42edb1878f09b3034b2f7c3362ef3c";
    string public sourceName = "testETH";
    string public baseSourceName = "eth";
    ...
    function run() external {
        ...
        FdcBase.writeToFile(
            dirPath,
            string.concat(attestationTypeName, "_abiEncodedRequest.txt"),
...
contract SubmitAttestationRequest is Script {
    function run() external {
        ...
        FdcBase.writeToFile(
            dirPath,
            string.concat(attestationTypeName, "_votingRoundId.txt"),
...
contract RetrieveProof is Script {
    function run() external {
        ...
        FdcBase.writeToFile(
            dirPath,
            string.concat(attestationTypeName, "_proof.txt"),
            StringsBase.toHexString(abi.encode(finalProof)),
            true
        );
    }
}
