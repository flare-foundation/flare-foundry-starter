...
contract HelloWorldTest is Test {
    ...
    function test_Constructor() public view {
        ...
        require(Strings.equal(greet1, expected1), string.concat("Expected: ", expected1, ", got:", greet1));

        string memory expected2 = string.concat("Hello, ", "Alderaan", "!");
        string memory greet2 = helloWorld.greetWorld();
        require(Strings.equal(greet2, expected2), string.concat("Expected: ", expected2, ", got:", greet2));
    }
    ...
    function test_GreetByName() public view {
        ...
        require(Strings.equal(greet, expected), string.concat("Expected: ", expected, ", got:", greet));
    }
}
