...
import { IOAppComposer } from "./interfaces/IOAppComposer.sol";
import { OFTComposeMsgCodec } from "./lib/OFTComposeMsgCodec.sol";
 ...
 * @notice Composer contract that receives FAssets via LayerZero and triggers automatic redemption
 * @dev Implements IOAppComposer to receive compose messages from LayerZero OFT transfers
 */
contract FAssetRedeemComposer is IOAppComposer, Ownable, ReentrancyGuard {
     ...
     * @param _message The composed message containing redemption details
     */
    function lzCompose(
        address /* _from */,
        bytes32 /* _guid */,
    ...
    /**
     * @notice Processes the redemption of FAssets
     * @param composeMsg The decoded compose message containing (amount, underlyingAddress, redeemer)
     */
