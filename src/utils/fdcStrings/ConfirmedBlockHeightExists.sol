...
library FdcStrings {
    ...
    function toJsonString(IConfirmedBlockHeightExists.RequestBody memory requestBody)
        internal
        pure
    ...
    function toJsonString(IConfirmedBlockHeightExists.ResponseBody memory responseBody)
        internal
        pure
        returns (string memory)
    {
