...
library FdcStrings {
    function toJsonString(IReferencedPaymentNonexistence.Request memory request)
        internal
        pure
    ...
    function toJsonString(IReferencedPaymentNonexistence.Response memory response)
        internal
        pure
        returns (string memory)
    {
    ...
    function toJsonString(IReferencedPaymentNonexistence.RequestBody memory requestBody)
        internal
        pure
        returns (string memory)
    {
    ...
    function toJsonString(IReferencedPaymentNonexistence.ResponseBody memory responseBody)
        internal
        pure
        returns (string memory)
    {
